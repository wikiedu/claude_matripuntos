...
- **2026-06-13 — MÓDULO E completo (UX/UI polish)**: E.1 empty states, E.2 PWA install prompt, E.3 a11y sheets/modales, E.4 skeletons, E.5 push toggle Settings, E.6 calendar day view 360 + link a detalle en todos los estados de EventNegotiationCard, E.7 journal prompt-focus + CTA retro vista, E.8 restos light-mode (app es dark-only) + dead code Alert/RuleProposalCard borrado. Commits: 302ae3d · a55c2f9 · 8383389 · fd53097 · baad809 · 1c9f9c7 · 85415a3 · 8400d5e. Bonus E.6: fix test flaky useMoodVigent (dependía de la hora de ejecución).
